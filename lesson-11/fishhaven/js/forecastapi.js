const aURL = "https://api.openweathermap.org/data/2.5/forecast?zip=83287,us&units=imperial&APPID=8789dd92c7cf955322e78e6d6bb50d55"
fetch(aURL)
...
document.getElementById("day3").textContent=week[((weekd+9)%7+1)];
document.getElementById("day4").textContent=week[((weekd+10)%7+1)];
document.getElementById("day5").textContent=week[((weekd+11)%7+1)];